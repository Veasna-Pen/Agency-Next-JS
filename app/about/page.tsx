...
const AboutPage = () => {
  return (
    <div className="mx-auto max-w-7xl px-10 my-20 ">
      ...
      <p className="p-4 text-gray-600 text-lg text-justify font-sans">
      ...
      <p className="text-justify text-lg px-4 font-sans text-gray-600  pt-2 pb-3">
